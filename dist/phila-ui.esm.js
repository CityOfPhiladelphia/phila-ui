...
__vue_render__$1._withStripped = true;
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-edd03552_0", { source: "#app[data-v-edd03552] {\n  padding-bottom: 46px;\n}\n#app .footer[data-v-edd03552] {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  padding: 0.625rem;\n}\n#app .footer ul[data-v-edd03552] {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n#app .footer ul li[data-v-edd03552] {\n  display: inline-block;\n  vertical-align: middle;\n  margin: 0 1rem;\n}\n\n/*# sourceMappingURL=AppFooter.vue.map */", map: {"version":3,"sources":["/home/runner/work/phila-ui/phila-ui/src/components/AppFooter/AppFooter.vue","AppFooter.vue"],"names":[],"mappings":"AA4EA;EACA,oBAAA;AC3EA;AD4EA;EACA,eAAA;EACA,SAAA;EACA,WAAA;EACA,iBAAA;AC1EA;AD2EA;EACA,gBAAA;EACA,UAAA;EACA,SAAA;ACzEA;AD0EA;EACA,qBAAA;EACA,sBAAA;EACA,cAAA;ACxEA;;AAEA,wCAAwC","file":"AppFooter.vue","sourcesContent":["<template>\n  <footer class=\"footer\">\n    <div class=\"has-text-centered\">\n      <ul class=\"inline-list\">\n        <li\n          v-for=\"(link, index) in localLinks\"\n          :key=\"index\"\n        >\n          <template v-if=\"typeof link.href === 'function'\">\n            <a\n              v-bind=\"link.attrs || {}\"\n              @click.prevent=\"link.href\"\n            >\n              {{ link.text }}\n            </a>\n          </template>\n          <template v-else-if=\"!isURL(link.href)\">\n            <router-link\n              :to=\"link.href\"\n              v-bind=\"link.attrs || {}\"\n            >\n              {{ link.text }}\n            </router-link>\n          </template>\n          <template v-else-if=\"isURL(link.href)\">\n            <a\n              :href=\"link.href\"\n              v-bind=\"link.attrs || {}\"\n            >{{ link.text }}</a>\n          </template>\n        </li>\n      </ul>\n    </div>\n  </footer>\n</template>\n<script>\nexport default {\n  name: 'AppFooter',\n  props: {\n    links: {\n      type: Array,\n      default: () => {\n        return []; // Each link requires at least a href and text properties.\n      },\n    },\n  },\n  computed: {\n    localLinks() {\n      // Prepare links\n      let localLinks = [];\n      this.links.forEach(link => {\n        let defaults =  { href: \"#\", text: \"link here\", \"attrs\": {}};\n        Object.keys(link).forEach(key =>  {\n          if (defaults[key]) {\n            defaults[key] = link[key];\n          } else {\n            defaults.attrs[key] = link[key];\n          }\n        });\n        localLinks.push(Object.assign({}, defaults));\n      });\n      return localLinks;\n    },\n  },\n  methods: {\n    isURL(link) {\n      return (/https?:\\/\\//.test(link));\n    },\n  },\n};\n</script>\n<style lang=\"scss\" scoped>\n  #app {\n    padding-bottom: 46px;\n    .footer {\n      position: fixed;\n      bottom: 0;\n      width: 100%;\n      padding: rem-calc(10px);\n      ul {\n        list-style: none;\n        padding: 0;\n        margin: 0;\n        li {\n          display: inline-block;\n          vertical-align: middle;\n          margin: 0 1rem;\n        }\n      }\n    }\n  }\n</style>\n","#app {\n  padding-bottom: 46px;\n}\n#app .footer {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  padding: 0.625rem;\n}\n#app .footer ul {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n#app .footer ul li {\n  display: inline-block;\n  vertical-align: middle;\n  margin: 0 1rem;\n}\n\n/*# sourceMappingURL=AppFooter.vue.map */"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-edd03552";
  /* module identifier */
...
// Import vue component
prepareForExport(component$7); // To allow use as module (npm/webpack/etc.) export component
...
export { component$1 as AppFooter, component as AppHeader, component$2 as Callout, component$3 as Checkbox, component$5 as Dropdown, component$4 as Radio, component$7 as TextArea, component$6 as Textbox, install };
